...
class LLMProvider:
    ...
    def get_last_usage(self) -> Usage:
        """
        Get the last usage information from the completion response.

        Returns:
            any: The last usage information from the completion response.
        """
        raise NotImplementedError("The get_last_usage method must be implemented in a subclass.")
