...
of the other text. Consider the glossary delimited by <GLOSSARY> and </GLOSSARY>. 
...
is delimited by <TRANSLATE_THIS> and </TRANSLATE_THIS> within the source text. Consider the glossary delimited by <GLOSSARY> and </GLOSSARY>.
...
PROMPT_IMPROVE_TRANSLATION = """Your task is to carefully read, then improve, a translation from {source_lang} to {target_lang}, taking into
...
Output only the new translation of the indicated part and nothing else. DO NOT include any XML tags."""
